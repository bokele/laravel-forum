            ...
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm bg-white" aria-label="Pagination">
                    <Link v-for="link in meta.links" :href="link.url" 
                        class="relative inline-flex items-center first-of-type:rounded-l-md last-of-type:rounded-r-md px-3 py-2    focus:z-20 "
                        :class="{
...
const previourUrl = computed(() => props.meta.links[0].url);
